...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lightning-flow-recipes-jp/flexsearch.min.js');loadScript('/lightning-flow-recipes-jp/jp.search-data.min.8d1cab6c262e4fde4e121d952842a4bf9bdb48985235dd89c1f23503853d2eaa.js',function(){input.required=false;search();});}
