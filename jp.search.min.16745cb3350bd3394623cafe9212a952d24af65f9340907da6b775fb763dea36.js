...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lightning-flow-recipes-jp/flexsearch.min.js');loadScript('/lightning-flow-recipes-jp/jp.search-data.min.5a1c9e8847d6a1bc82feb1d91a63775382bf80415c6fa6e2f5247a41c689ac7e.js',function(){input.required=false;search();});}
