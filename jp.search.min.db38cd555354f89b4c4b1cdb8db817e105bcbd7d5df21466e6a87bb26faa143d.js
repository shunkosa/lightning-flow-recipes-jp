...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/lightning-flow-recipes-jp/flexsearch.min.js');loadScript('/lightning-flow-recipes-jp/jp.search-data.min.da174406c9199d11b398f6d7d3efce69849c5d0ca05fe60a46984f4dcbbb3cdf.js',function(){input.required=false;search();});}
