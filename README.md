...
* Sandbox 組織
    * https://test.salesforce.com/packaging/installPackage.apexp?p0=04tf4000004EywhAAC
* Developer Edition 組織
    * https://login.salesforce.com/packaging/installPackage.apexp?p0=04tf4000004EywhAAC
* 新しい Trailhead Playground 組織
    * アプリケーションランチャーから、[Playground Starter] アプリケーションを起動し、[パッケージのインストール] タブをクリックします。インストール ID に、`04tf4000004EywhAAC` を入力し、[インストール] ボタンをクリックしてください。
...
|[取引先から取引先責任者に一括メールを送信する画面](docs/MassEmailToContactsScreen/MassEmailToContactsScreen.md)|・子レコードを取得する (コレクション変数の使い方)<br>・[ループ] の使い方<br>・[決定] の使い方<br>・メール送信アクション|
...
|[毎朝9時に完了予定日を過ぎた商談の所有者に Chatter でメンションするスケジュールフロー](docs/ScheduledOpportunityChatterReminder/ScheduledOpportunityChatterReminder.md)|・フローのスケジュール実行<br>・Chatter通知|
